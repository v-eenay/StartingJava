...
public class MovieGuess {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out
                    .println("Greetings, " + playerName + "! May your guesses be as sharp as a Hitchcock plot twist.");
            ...
            while (keepRunning) {
                ...
                System.out.println("2. See the list of movies (Spoilers: No spoilers here!)");
